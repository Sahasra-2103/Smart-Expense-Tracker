...
/**
 * Frontend Scaffolder
 * Run this with: node generate-frontend.js
 * From: d:\Tracker directory
 */

const fs = require('fs');
const path = require('path');

console.log('\n🚀 Generating Frontend Scaffold...\n');
...
export default api;
`,
  'src/context/AuthContext.js': `import React, { createContext, useState } from 'react';
